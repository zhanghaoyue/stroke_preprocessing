...
reg.inputs.fixed_image = os.path.join(test_dir, '5492881_pre_FLAIR.nii.gz')
reg.inputs.moving_image = os.path.join(test_dir, '5492881_post_FLAIR.nii.gz')
...
reg.inputs.output_warped_image = os.path.join(test_dir, '5492881_post_FLAIR_r.nii.gz')
...
at.inputs.input_image = os.path.join(test_dir, '5492881_post_TMAX.nii.gz')
at.inputs.reference_image = os.path.join(test_dir, '5492881_post_FLAIR_r.nii.gz')
at.inputs.output_image = os.path.join(test_dir, '5492881_post_TMAX_r.nii.gz')
at.inputs.default_value = 0
at.inputs.transforms = os.path.join(test_dir, '5492881_transform.matComposite.h5')
print(at.cmdline)
