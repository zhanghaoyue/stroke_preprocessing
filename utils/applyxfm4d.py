...
class ApplyXfm4D(FSLCommand):
    ...
    >>> applyxfm4d.inputs.single_matrix = example_data('functional_mcf.mat')
    >>> applyxfm4d.inputs.out_file = 'newfile.nii'
    >>> applyxfm4d.inputs.ref_vol = example_data('functional_mcf.nii')
    >>> result = applyxfm4d.run() # doctest: +SKIP
